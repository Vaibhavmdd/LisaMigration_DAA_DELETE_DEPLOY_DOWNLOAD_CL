...
<TestCase name="5.18.analyze" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176.hf33" author="admin" date="04/03/2023" host="na2devasgaks01" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176.hf33" author="admin" date="04/03/2023" host="na2devasgaks01" />
</meta>

<id>E86D5B14D2A911ED8BD2506B8D8BDEB5</id>
...
<sig>ZWQ9NSZ0Y3Y9MiZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYuaGYzMykmbm9kZXM9NDQ5OTg2MDQ3</sig>
...
<deletedProps>
    ...
    <Node name="deployApp" log=""
          ...
          version="1" 
          uid="E86D5B15D2A911ED8BD2506B8D8BDEB5" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="getWsdl" > 
...
<SaveProps>
    ...
    <Node name="getWsdl" log="Get runtime WSDL"
          ...
          version="2" 
          uid="E86D5B16D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="invokeService" > 
...
<params-saved-as-unicode>false</params-saved-as-unicode>
    ...
    <Node name="invokeService" log=""
          ...
          version="1" 
          uid="E86D5B17D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="stopTIBCOHost" > 
...
<customHTTPHeaderInfo>
    ...
    <Node name="stopTIBCOHost" log="Stop TIBCO Host with Mode=normal and Wait=true"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B18D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="wait" > 
...
<SaveProps>
    ...
    <Node name="wait" log="repeat sleep"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B19D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
...
<SaveProps>
    ...
    <Node name="verifyTIBCOHostDown" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B1AD2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
...
<SaveProps>
    ...
    <Node name="verifyNode1Down" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B1BD2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
...
<SaveProps>
    ...
    <Node name="verifyNode2Down" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B1CD2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
...
<SaveProps>
    ...
    <Node name="verifySystemNodeDown" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B1DD2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
...
<SaveProps>
    ...
    <Node name="backupTIBCOHostLog" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B1ED2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="startTIBCOHost" > 
...
<SaveProps>
    ...
    <Node name="startTIBCOHost" log="Re-start TIBCO Host"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B1FD2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="checkAdminUp" > 
...
<SaveProps>
    ...
    <Node name="checkAdminUp" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B20D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="getTimeLimit" > 
...
<SaveProps>
    ...
    <Node name="getTimeLimit" log="get the timelimit"
          ...
          version="1" 
          uid="E86D5B21D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="true" 
          next="repeatGetWsdl" > 
...
<script>Calendar future = Calendar.getInstance();&#10;future.add(Calendar.SECOND, timeout.intValue());&#10;testExec.setStateValue(&quot;future&quot;, future);</script>
    ...
    <Node name="repeatGetWsdl" log=""
          type="com.itko.lisa.test.URLTrans" 
          version="2" 
          uid="E86D5B22D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
...
<params-saved-as-unicode>false</params-saved-as-unicode>
    ...
    <Node name="wait-for-Admin-Plugin-Init" log="repeat sleep"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B24D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="invokeService2" > 
...
<SaveProps>
    ...
    <Node name="invokeService2" log=""
          type="com.itko.lisa.ws.RawSOAPNode" 
          version="1" 
          uid="E86D5B25D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="undeployApp" > 
...
<customHTTPHeaderInfo>
    ...
    <Node name="undeployApp" log="Undeploy, delete app"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B26D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="end" > 
...
<SaveProps>
    ...
    <Node name="repeatSleep" log="repeat sleep"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="E86D5B23D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="repeatGetWsdl" > 
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="10B2E261D2AC11ED8BD2506B8D8BDEB5" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
    ...
    <Node name="fail" log=""
          ...
          version="1" 
          uid="E86D5B28D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="true" 
          next="" > 
    ...
    <Node name="end" log=""
          ...
          version="1" 
          uid="E86D5B27D2A911ED8BD2506B8D8BDEB5" 
          think="0-0" 
          useFilters="true" 
          quiet="true" 
          next="fail" > 
