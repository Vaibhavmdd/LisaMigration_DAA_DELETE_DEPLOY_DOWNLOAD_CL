...
<!-- On: Thu May 16 22:58:22 PDT 2013 -->


<TestCase name="install2" version="2">
<id>98d71d84</id>
<Documentation>suite installation in silent mode of:&#13;&#10;- ActiveMatrix Service Grid&#13;&#10;- CPP IT&#13;&#10;- Adapter BT&#13;&#10;- EJB BT&#13;&#10;- CLR IT (on Windows only)</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS0xODU3NjEyNzAx</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.cleanUpTIBCOEnvRegistry.rsp</key>
    <value>Set in Step cleanUpTIBCOEnvRegistry</value>
    </Parameter>
    <Parameter>
    <key>lisa.cleanUpTIBCOEnvRegistry.rsp.time</key>
    <value>Set in Step cleanUpTIBCOEnvRegistry</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.deleteInstallShieldRegistry2.rsp</key>
    <value>Set in Step deleteInstallShieldRegistry2</value>
    </Parameter>
    <Parameter>
    <key>lisa.deleteInstallShieldRegistry2.rsp.time</key>
    <value>Set in Step deleteInstallShieldRegistry2</value>
    </Parameter>
    <Parameter>
...
<valueToAssertKey></valueToAssertKey>
 ...
 useFilters="true" 
 quiet="false" 
          next="deleteInstallShieldRegistry2" > 
...
<then>deleteInstallShieldRegistry2</then>
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="deleteInstallShieldRegistry2" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{installShieldRegistryOnWindows64}}/TIBCO</value>
    <name>File or directory to be deleted</name>
    </Parameter>
</Parameters>
<SaveProps>
