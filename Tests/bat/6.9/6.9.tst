...
<id>febc86e8</id>
<Documentation>Scenario: WebApp &lt;-&gt; Mediation &lt;-&gt; Java &#13;&#10;MEP: In-Out&#13;&#10;&#13;&#10;- Deploy - Invoke&#13;&#10;- Undeploy/Redeploy - Invoke again&#13;&#10;- Undeploy</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9MiZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYuaGYzMykmbm9kZXM9LTEzMDQ4MjgyNjA=</sig>
...
<SaveProps>
    ...
    <Node name="InvokeWebApp" log=""
          type="com.itko.lisa.test.URLTrans" 
          version="2" 
          uid="febc86e8-InvokeWebApp" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="undeployApp" > 
...
<log>&quot;{{Name}}&quot; not found in response</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{Name}}</param>
</CheckResult>

<CheckResult assertTrue="false" name="Assert242" type="com.itko.lisa.test.CheckResultContains">
<log>&quot;{{Address}}&quot; not found in response</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{Address}}</param>
</CheckResult>
...
<query>Name={{Name}}&amp;Address={{Address}}&amp;City={{City}}&amp;State={{State}}&amp;Zip={{Zip}}</query>
</url>
<images>false</images>
<sslInfo>
</sslInfo>
...
<SaveProps>
    ...
    <Node name="InvokeWebApp2" log=""
          type="com.itko.lisa.test.URLTrans" 
          version="2" 
          uid="febc86e8-InvokeWebApp2" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="undeployApp2" > 
      ...
      <!-- Assertions -->
<CheckResult assertTrue="false" name="Assert207" type="com.itko.lisa.test.CheckResultContains">
<log>&quot;{{Name}}&quot; not found in response</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{Name}}</param>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="781FC902A92011ED9E1D506B8D8BDEB5" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
