...
#ifndef WSDL_COM_TIBCO_AMX_EJBBT_IQATEST_COMPANYADDRESS_ADDRESSREMOTEPORTTYPEADDRESSREMOTEPORTTYPEPROXY_H_
#define WSDL_COM_TIBCO_AMX_EJBBT_IQATEST_COMPANYADDRESS_ADDRESSREMOTEPORTTYPEADDRESSREMOTEPORTTYPEPROXY_H_
...
{
	class AddressRemotePortTypeAddressRemotePortTypeProxy : public TIBAMX_CPP_NAMESPACE::CppMessageProxy
	{
	public:
		AddressRemotePortTypeAddressRemotePortTypeProxy() {}
		virtual ~AddressRemotePortTypeAddressRemotePortTypeProxy() {}
	...
	private:
		...
		static const XMLCh* NS_ADDRESSREQUESTARGS0;
		static const XMLCh* HTTP___COMPANYADDRESS_IQATEST_EJBBT_AMX_TIBCO_COM;
		static const XMLCh* NS_ADDRESSREQUEST;
		static const XMLCh* ADDRESSREQUESTRESPONSE;
		static const XMLCh* REMOTEEXCEPTION;
	}; //END of AddressRemotePortTypeAddressRemotePortTypeProxy
