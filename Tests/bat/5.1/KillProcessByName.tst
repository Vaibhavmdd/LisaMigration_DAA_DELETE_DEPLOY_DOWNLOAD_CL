...
<!-- On: Tue May 07 13:14:21 PDT 2013 -->


<TestCase name="KillProcessByName" version="2">
<id>47cfddfd</id>
...
<script>// ps -e command used to get the PID has some restriction on some Unix platforms:&#10;// The process name might truncated.&#10;&#10;processName2 = processName;&#10;&#10;// Linux ps -e command returns 15 characters max&#10;if (os_name.equals(&quot;Linux&quot;)) {&#10; if (testExec.parseInState(processName).length() &gt; 15)&#10;  processName2 = testExec.parseInState(processName).substring(0,15);&#10;}&#10;// HP-UX ps -e command returns 14 characters max&#10;else if (os_name.equals(&quot;HP-UX&quot;)) {&#10; if (testExec.parseInState(processName).length() &gt; 14)&#10;  processName2 = testExec.parseInState(processName).substring(0,14);&#10;}&#10;// Solaris ps -e command returns 8 characters max&#10;else if (os_name.equals(&quot;SunOS&quot;)) {&#10; if (testExec.parseInState(processName).length() &gt; 8)&#10;  processName2 = testExec.parseInState(processName).substring(0,8);&#10;}&#10;// AIX does not have limitation.&#10;return processName2;</script>
      ...
      <!-- Filters -->
      <Filter type="com.itko.lisa.test.FilterSaveResponse">
        <valueToFilterKey>lisa.UnixProcessModifier.rsp</valueToFilterKey>
...
<exitCodes>
      ...
      <!-- Result Elements -->
<CheckResult assertTrue="true" name="Assert157" type="com.itko.lisa.test.CheckResultContains">
<log>Declare failure if Not owner</log>
<then>killOk</then>
        <param>Not owner</param>
</CheckResult>

<CheckResult assertTrue="true" name="Assert122" type="com.itko.lisa.test.CheckResultContains">
<log>Declare fail if Operation not permitted</log>
<then>killOk</then>
        <param>Operation not permitted</param>
</CheckResult>
...
<graphy>-1</graphy>
<onerror>fail</onerror>
<script>if (com.itko.util.Utilities.isWindows())&#10; return resultMsg;&#10;else{&#10;    if (resultMsg.contains(&quot;Not owner&quot;) || resultMsg.contains(&quot;Operation not permitted&quot;))&#10;        throw new Exception(&quot;Not permitted to perform &quot; + processName + &quot; kill&quot;);&#10;}&#10;return &quot;SUCCESS: &quot; + resultMsg; &#10;</script>

      <!-- Filters -->
      <Filter type="com.itko.lisa.test.FilterSaveResponse">
        <valueToFilterKey>lisa.killOk.rsp</valueToFilterKey>
      <prop>exitMessage</prop>
      </Filter>
