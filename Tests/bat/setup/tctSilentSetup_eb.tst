...
<!-- On: Mon Feb 01 11:42:52 PST 2016 -->
...
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTE0ODI3MTY1NTI=</sig>
<rootNode>CopyOldJarBackToTIBCO_HOME</rootNode>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.copySystemNodeLog.rsp.time</key>
    <value>Set in Step copySystemNodeLog</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.copySystemNodeLog.rsp</key>
    <value>Set in Step copySystemNodeLog</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.CopyEBJars.rsp</key>
    <value>Set in Step CopyEBJars</value>
    </Parameter>
    <Parameter>
    <key>lisa.CopyEBJars.rsp.time</key>
    <value>Set in Step CopyEBJars</value>
    </Parameter>
    <Parameter>
    <key>lisa.stopTIBCOHost2.rsp</key>
    <value>Set in Step stopTIBCOHost2</value>
    </Parameter>
    <Parameter>
    <key>lisa.stopTIBCOHost2.rsp.time</key>
    <value>Set in Step stopTIBCOHost2</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.checkAdminUp2.rsp</key>
    <value>Set in Step checkAdminUp2</value>
    </Parameter>
    <Parameter>
    <key>lisa.checkAdminUp2.rsp.time</key>
    <value>Set in Step checkAdminUp2</value>
    </Parameter>
    <Parameter>
    <key>lisa.CopyOldJarBackToTIBCO_HOME.rsp</key>
    <value>Set in Step CopyOldJarBackToTIBCO_HOME</value>
    </Parameter>
    <Parameter>
    <key>lisa.CopyOldJarBackToTIBCO_HOME.rsp.time</key>
    <value>Set in Step CopyOldJarBackToTIBCO_HOME</value>
    </Parameter>
</resultState>
...
<doc>{{LISA_TC_PATH}}/../2node_ldap{{g11n}}.config</doc>
    ...
    <Node name="CopyOldJarBackToTIBCO_HOME" log=""
...
<graphx>970</graphx>
<graphy>970</graphy>
<Subprocess>{{TIBCO_AMX_LIBRARY}}/com/tibco/amx/CopyEBJars.tst</Subprocess>
...
<Parameters>
    ...
    <value>{{TIBCO_AMX_TEST_FUNC_RT}}/bat/setup/build.properties.template</value>
...
<graphx>10</graphx>
<graphy>10</graphy>
<cmd>{{TIBCO_HOME}}/tct/{{tctStartInDir}}/TIBCOConfigurationTool{{tctPostFix}} -silentMode -wizard.id com.tibco.tct.admin -wizard.props {{tibco.test.case.log.dir}}/build.properties</cmd>
<basedir>{{TIBCO_HOME}}/tct/{{tctStartInDir}}/</basedir>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="copyAdminPropFile2" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<Parameters>
    ...
    <Parameter>
    <key>fileOut</key>
    <value>{{TIBCO_AMX_TEST_FUNC_RT}}/bat/setup/admin.properties</value>
    <name>Destination file or directory</name>
    </Parameter>
    <Parameter>
    <key>createDirectory</key>
...
<SaveProps>
      ...
      <!-- Result Elements -->
<CheckResult assertTrue="false" name="Assert147" type="com.itko.lisa.test.CheckResultRegEx">
<log>No need to run patch manager for {{targetVersion}}</log>
<then>end</then>
<valueToAssertKey></valueToAssertKey>
        <param>succ done copy!</param>
</CheckResult>

    </Node>


    <Node name="stopTIBCOHost2" log="Stop TIBCO Host with Mode=abort and Wait=true"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
