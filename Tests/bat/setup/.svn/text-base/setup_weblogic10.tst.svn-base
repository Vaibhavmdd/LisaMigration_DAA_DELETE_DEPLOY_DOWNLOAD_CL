...
<!-- On: Thu Sep 06 15:34:14 GMT+08:00 2012 -->
...
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS0xMDEzMzU5MTAx</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.startTIBCOHost_afterModifyTRA.rsp</key>
    <value>Set in Step startTIBCOHost_afterModifyTRA</value>
    </Parameter>
    <Parameter>
    <key>lisa.startTIBCOHost_afterModifyTRA.rsp.time</key>
    <value>Set in Step startTIBCOHost_afterModifyTRA</value>
    </Parameter>
    <Parameter>
    <key>lisa.wait22.rsp</key>
    <value>Set in Step wait22</value>
    </Parameter>
    <Parameter>
    <key>lisa.wait22.rsp.time</key>
    <value>Set in Step wait22</value>
    </Parameter>
</resultState>
...
<SaveProps>
 ...
 useFilters="true" 
 quiet="false" 
          next="stopTIBCOHost_beforeModifyTRA" > 
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="stopTIBCOHost_beforeModifyTRA" log="Stop TIBCO Host with Mode=abort and Wait=true"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<graphx>-1</graphx>
<graphy>-1</graphy>
<cmd>java -jar TRARepace.jar -TRA_FILE {{TIBCO_CONFIG_HOME}}/tibcohost/{{host.instance}}/data_3.2.x/nodes/{{env.node1.name}}/bin/tibamx_{{env.node1.name}}.tra -key java.property.sun.lang.ClassLoader.allowArraySyntax=true</cmd>
<basedir>{{LISA_TC_PATH}}/../../ejb/dependencies</basedir>
<toNode>fail</toNode>
...
<exitCodes>
 ...
 useFilters="true" 
 quiet="false" 
          next="startTIBCOHost_afterModifyTRA" > 

<graphx>-1</graphx>
<graphy>-1</graphy>
<cmd>java -jar TRARepace.jar -TRA_FILE {{TIBCO_CONFIG_HOME}}/tibcohost/{{host.instance}}/data_3.2.x/nodes/{{env.node2.name}}/bin/tibamx_{{env.node2.name}}.tra -key java.property.sun.lang.ClassLoader.allowArraySyntax=true</cmd>
<basedir>{{LISA_TC_PATH}}/../../ejb/dependencies</basedir>
<toNode>fail</toNode>
<exceptionNode>fail</exceptionNode>
<timeOut>300</timeOut>
...
<exitCodes>
    ...
    <Node name="startTIBCOHost_afterModifyTRA" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<graphy>1641</graphy>
    ...
    <DataSet type="com.itko.lisa.test.DataSheet" name="AdminPropertyValues" atend="bootstrapAdmin" local="false" >
