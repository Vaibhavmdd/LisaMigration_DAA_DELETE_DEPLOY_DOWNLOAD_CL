...
<!-- On: Thu May 12 03:12:42 PDT 2022 -->
...
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTE1NzM1Mjg1Mjk=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.copyQANode2Log.rsp</key>
    <value>Set in Step copyQANode2Log</value>
    </Parameter>
    <Parameter>
    <key>lisa.copyQANode2Log.rsp.time</key>
    <value>Set in Step copyQANode2Log</value>
    </Parameter>
    <Parameter>
    <key>lisa.copyQANode1Log.rsp</key>
    <value>Set in Step copyQANode1Log</value>
    </Parameter>
    <Parameter>
    <key>lisa.copyQANode1Log.rsp.time</key>
    <value>Set in Step copyQANode1Log</value>
    </Parameter>
</resultState>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="copyQANode1Log" log="QANode1&apos;s log to the reports dir"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<Parameters>
    <Parameter>
    <key>fileIn</key>
    <value>{{TIBCO_CONFIG_HOME}}/tibcohost/{{host.instance}}/data_3.2.x/nodes/QANode1/logs/QANode1.log</value>
    <name>Source file</name>
    </Parameter>
    <Parameter>
    <key>fileOut</key>
    <value>{{logappender.file.location}}/QANode1.log</value>
    <name>Destination file or directory</name>
    </Parameter>
    <Parameter>
    <key>createDirectory</key>
...
<SaveProps>
    ...
    <Node name="copyQANode2Log" log="QANode1&apos;s log to the reports dir"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<Parameters>
    <Parameter>
    <key>fileIn</key>
    <value>{{TIBCO_CONFIG_HOME}}/tibcohost/{{host.instance}}/data_3.2.x/nodes/QANode2/logs/QANode2.log</value>
    <name>Source file</name>
    </Parameter>
    <Parameter>
    <key>fileOut</key>
    <value>{{logappender.file.location}}/QANode2.log</value>
    <name>Destination file or directory</name>
    </Parameter>
    <Parameter>
    <key>createDirectory</key>
