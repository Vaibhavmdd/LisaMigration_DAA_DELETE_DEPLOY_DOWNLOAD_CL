...
public class Java1 extends AbstractJava1 {
	...
	public AddResponseDocument add(AddDocument parameters) {
		...
		HelloRequestDocument lname= HelloRequestDocument.Factory.newInstance();		
		lname.setHelloRequest("Syed");
		HelloResponseDocument resp= getHelloWorldPT().sayHello(name,lname); 
	...
	public SubtractResponseDocument subtract(SubtractDocument parameters) {
		...
		HelloRequestDocument lname= HelloRequestDocument.Factory.newInstance();		
		lname.setHelloRequest("Syed");	
		HelloResponseDocument resp2= getHelloWorldPT().sayHello(name,lname); 
