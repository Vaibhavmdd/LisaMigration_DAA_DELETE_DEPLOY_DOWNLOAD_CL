...
<!-- On: Tue Jan 12 20:32:57 IST 2016 -->


<TestCase name="hf_330_5.12.4-TAP-12760" version="5">
<id>cb9518c6</id>
<Documentation>Description:  Download DAA file for in a given location i.e relative path. Upload the same downloaded file.&#13;&#10;MEP:In-Out&#13;&#10;Composite: Soap&lt;-&gt;Java&#13;&#10;&#13;&#10;</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS0yMDM2NzYyMDEx</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.undeployDownloadedApp.rsp</key>
    <value>Set in Step undeployDownloadedApp</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.deployDownloadedDAA.rsp</key>
    <value>Set in Step deployDownloadedDAA</value>
    </Parameter>
    <Parameter>
    <key>lisa.deployDownloadedDAA.rsp.time</key>
    <value>Set in Step deployDownloadedDAA</value>
    </Parameter>
    <Parameter>
    <key>lisa.undeployDownloadedApp.rsp.time</key>
    <value>Set in Step undeployDownloadedApp</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.deleteDownloadedApp.rsp</key>
    <value>Set in Step deleteDownloadedApp</value>
    </Parameter>
    <Parameter>
    <key>lisa.deleteDownloadedApp.rsp.time</key>
    <value>Set in Step deleteDownloadedApp</value>
    </Parameter>
    <Parameter>
    <key>username</key>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{TIBCO_AMX_TEST_FUNC_RT}}/hf/330/5.12.4/DownloadedDAA/jv.helloworld1.soa.daa</value>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="deployDownloadedDAA" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
 quiet="false" 
          next="undeployDownloadedApp" > 
...
<Parameters>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>deployTimeout=800,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig1.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/downloadDAA-TAP-12760/2node.config</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="undeployDownloadedApp" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
 quiet="false" 
          next="deleteDownloadedApp" > 
...
<Parameters>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>undeployTimeout=600,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig1.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/downloadDAA-TAP-12760/2node.config</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="deleteDownloadedApp" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<Parameters>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>deleteAppTimeout=600,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig1.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/downloadDAA-TAP-12760/2node.config</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
