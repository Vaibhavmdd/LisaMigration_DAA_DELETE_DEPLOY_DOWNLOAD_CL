...
<!-- On: Thu Oct 29 04:51:12 PDT 2020 -->


<TestCase name="hf_330_5.12.11-TAP-12760" version="5">
<id>cb9518c6</id>
<Documentation>Description:  Download DAA file when user deletes feature from the admin staging area&#13;&#10;MEP:In-Out&#13;&#10;Composite: Soap&lt;-&gt;Java&#13;&#10;&#13;&#10;</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS05NjU4Njk2Njc=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.remove.feature.rsp</key>
...
<Parameters>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>remove.featureTimeout=600,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/downloadDAA-TAP-12760/2node.config</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
    ...
    <Parameter>
    <key>timeout</key>
    <value>{{remove.featureTimeout}}</value>
    <name>Timeout in seconds for ant command. Required only if waitForCompletion is true</name>
    </Parameter>
</Parameters>
<SaveProps>
