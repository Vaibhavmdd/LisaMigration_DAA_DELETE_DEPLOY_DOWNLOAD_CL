...
<TestCase name="hf_330_5.11.7-TAP-13024" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/07/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/22/2023" host="na2devasgora03" />
</meta>

<id>cb9518c6</id>
<Documentation>Description:  Delete DAA file that is &quot;in use&quot;&#13;&#10;MEP:In-Out&#13;&#10;Composite: Soap&lt;-&gt;Spring</Documentation>
...
<SaveProps>
    ...
    <Node name="deleteDAA" log=""
      ...
      <!-- Assertions -->
<CheckResult assertTrue="false" name="Check for Error" type="com.itko.lisa.test.CheckResultContains">
<log>Delete DAA of Application on host finished.....</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>One or more DAA(s) you selected for deletion happen to be in use, and hence were not deleted.</param>
</CheckResult>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="F81E3DC2052E11EE98D7506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
