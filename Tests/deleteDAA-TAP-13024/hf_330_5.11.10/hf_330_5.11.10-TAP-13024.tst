...
<TestCase name="hf_330_5.11.10-TAP-13024" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/15/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/22/2023" host="na2devasgora03" />
</meta>

<id>cb9518c6</id>
<Documentation>Description:  Delete multiple DAA file that is &quot;in use&quot;&#13;&#10;MEP:In-Out&#13;&#10;Composite: Soap&lt;-&gt;spring</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPTExNjM0ODYxNg==</sig>
...
<SaveProps>
    ...
    <Node name="deleteDAA" log=""
      ...
      <!-- Assertions -->
<CheckResult assertTrue="false" name="Check for delete error" type="com.itko.lisa.test.CheckResultContains">
<log>Delete DAA file on host finished.....</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>Delete of DAA failed.: TIBCO-AMX-ADMIN-015053: One or more DAA(s) you selected for deletion happen to be in use, and hence were not deleted.</param>
</CheckResult>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="40E421E10B6111EEB5C8506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
