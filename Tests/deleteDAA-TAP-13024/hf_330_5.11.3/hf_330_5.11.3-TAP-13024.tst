...
<TestCase name="hf_330_5.11.3-TAP-13024" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/06/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/22/2023" host="na2devasgora03" />
</meta>

<id>cb9518c6</id>
<Documentation>Description:  Delete DAA file that is not in use&#13;&#10;MEP:In-Out&#13;&#10;Composite: Soap&lt;-&gt;spring</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPTE0MjQ4NTgwMjM=</sig>
...
<SaveProps>
    ...
    <Node name="removeFeature" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="cb9518c6-removeFeature" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="removeAppTemplate" > 
...
<Parameters>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>removeTimeout=600,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/deleteDAA-TAP-13024/2node.config</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
...
<SaveProps>
    ...
    <Node name="removeAppTemplate" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="cb9518c6-removeAppTemplate" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="deleteDAA" > 
...
<Parameters>
    ...
    <Parameter>
    <key>targetName</key>
    <value>remove.apptemplate</value>
    <name>Name of the build target to be invoked. Optional.</name>
    </Parameter>
    <Parameter>
    <key>propertyFileName</key>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>removeappTimeout=600,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/deleteDAA-TAP-13024/2node.config</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
...
<SaveProps>
    ...
    <Node name="deleteDAA" log=""
      ...
      <!-- Assertions -->
<CheckResult assertTrue="false" name="BUILD FAILED" type="com.itko.lisa.test.CheckResultContains">
<log>Configuration and Undeployment of Application on host finished.....</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>No DAA was found with name &apos;spring.helloworld.soa.daa&apos;</param>
</CheckResult>
...
<Parameters>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>deleteDaaTimeout=600,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/deleteDAA-TAP-13024/2node.config</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="8A5629F5043E11EE9608506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
