...
<TestCase name="hf_330_5.11.2-TAP-13024" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/05/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="06/05/2023" host="na2devasgora03" />
</meta>

<id>cb9518c6</id>
<Documentation>Description:  Delete DAA file that is &apos;Not In Use&apos; directly from DAA tab .Also Application does not contain feature in it.&#13;&#10;MEP:In-Out&#13;&#10;Composite: Soap&lt;-&gt;Mediation-&gt;Soap</Documentation>
...
<Parameters>
    ...
    <value>deployTimeout=800,TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{LISA_TC_PATH}}/amxconfig.xml,remotePropsFile=C:/Lisa1072/Projects/AMX/Tests/deleteDAA-TAP-13024/2node.config</value>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="C290B977039C11EE9C50506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
