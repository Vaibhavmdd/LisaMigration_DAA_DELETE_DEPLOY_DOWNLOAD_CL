...
//				+ parentcontextId);
		...
		logger.debug("QA,debug.say hello in Java1 component");
		logger.info("QA,info.say hello in Java1 component");
		logger.warn("QA,warn.say hello in Java1 component");
		logger.error("QA,error.say hello in Java1 component");
		logger.trace("QA,trace.say hello in Java1 component");
