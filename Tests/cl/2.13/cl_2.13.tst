...
<TestCase name="cl_2.13" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/13/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/13/2023" host="na2devasgora03" />
</meta>

<id>9f9a4397</id>
<Documentation>Description :   Test ClearText Logging for tracing     &#13;&#10;                CL-2292:&#13;&#10;                Admin UI provides the Add Appender capability to an existing logger which CLI doesn&apos;t have. &#13;&#10;                We should be able to add appender to an existing logger through CLI.&#13;&#10;                &#13;&#10;                steps:&#13;&#10;                create and configure ClearText Appender to existing logger &quot;com.tibco&quot; for QANode2 in DevNode&#13;&#10;                level, check files to make sure this appender added successfully, delete this appender in both &#13;&#10;                DevNode and Logging Appender page ,check the &quot;node-log4j.xml&quot; to verify results.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS0xMTQyNTMyODE0</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="1BFF494E216611EEAF26506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="createAppender" > 
...
<SaveProps>
    ...
    <Node name="verifyAppender" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-verifyAppender" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="verifyLogExist" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{TIBCO_CONFIG_HOME}}\tibcohost\Admin-AMXAdmin-admin1\data_3.2.x\nodes\QANode2\configuration\node-log4j.xml</value>
...
<save>lisa.end.rsp.time</save>
    ...
    <Node name="verifyLogExist" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-verifyLogExist" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="deleteAppender" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL2_13_Text.log</value>
...
<SaveProps>
    ...
    <Node name="re-deployLogging" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-re-deployLogging" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="re-verifyAppender" > 
...
<Parameters>
    ...
    <Parameter>
    <key>logFileName</key>
    <value>{{tibco.test.case.log.dir}}/re-deployLogging.log</value>
    <name>Absolute path to the Ant log file. Optional.</name>
    </Parameter>
    <Parameter>
    <key>targetName</key>
...
<SaveProps>
    ...
    <Node name="re-verifyAppender" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-re-verifyAppender" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="end" > 
      ...
      <!-- Assertions -->
<CheckResult assertTrue="true" name="Check for application response" type="com.itko.lisa.test.CheckResultContains">
<log>Did not contain &apos;{{appResp}}&apos; in application response</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{appResp}}</param>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{TIBCO_CONFIG_HOME}}\tibcohost\Admin-AMXAdmin-admin1\data_3.2.x\nodes\QANode2\configuration/node-log4j.xml</value>
    <name>File to read</name>
    </Parameter>
    <Parameter>
    <key>encoding</key>
...
<save>lisa.end.rsp.time</save>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="4500877F216511EEAF26506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
