...
<TestCase name="cl_3.2" version="5">
...
<id>f2e92539</id>
<Documentation>Description :   Test JMS Logging for DevNode&#13;&#10;                &#13;&#10;                Note by Leveon:&#13;&#10;                Configure a JMS appender for DevNode root logger&#13;&#10;                Deploy a DAA without any logging configuration, invoke the DAA to generate logs. these logs should be capatured by&#13;&#10;                root logger of DevNode on which DAA was deployed. query logs from DB to verify.&#13;&#10;                &#13;&#10;Scenario:       SOAP HTTP &lt;-&gt; Java</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS0xMjM4NjE0Mjk4</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="1F675C50261511EEB8EF506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<log>Did not contain &apos;{{resp1}}&apos; in query result</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <column>MSG</column>
        <regEx>{{resp1}}</regEx>
...
<log>Did not contain &apos;{{resp2}}&apos; in query result</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <column>MSG</column>
        <regEx>{{resp2}}</regEx>
...
<password_enc>lcf69d0048c721be4b9f0addfc15e4214ad9c7dc06623fe0303a88516a186bf98c72eb8c6fd0df1635f02031eb73e5a99088342bcef17480874fd24bdfb</password_enc>
<onSQLError>fail</onSQLError>
<resultSet>true</resultSet>
<maxRows>-1</maxRows>
<keepOpen>false</keepOpen>
<usePool>false</usePool>
<sql>SELECT MSG  FROM  &quot;BASEEVENTFORMAT&quot; WHERE MSG like &apos;%This is the Java component%&apos;</sql>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="DD6FB1AE261411EEB8EF506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
