...
//				+ parentcontextId);
//		
		logger.debug("QA,debug.say hello 33 in java2 component");
		logger.info("QA,info.say hello 33 in java2 component");
		logger.warn("QA,warn.say hello 33 in java2 component");
		logger.error("QA,error.say hello 33 in java2 component");
		logger.trace("QA,trace.say hello 33 in java2 component");
