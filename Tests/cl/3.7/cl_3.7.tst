...
<!-- On: Wed Mar 13 02:31:26 PDT 2019 -->


<TestCase name="cl_3.7" version="2">
<id>f2e92539</id>
<Documentation>Description :  Create A JMS Appender and configure this JMS appender(INFO Level) to com.tibco logger of  SystemHost&#13;&#10;               Check hpa_log4j.xml of host to verify if JMS appender was configured</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTkwMjA1MTg1Mg==</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.copy hpa_log4j.rsp</key>
    <value>Set in Step copy hpa_log4j</value>
    </Parameter>
    <Parameter>
    <key>lisa.copy hpa_log4j.rsp.time</key>
    <value>Set in Step copy hpa_log4j</value>
    </Parameter>
    <Parameter>
    <key>lisa.verify hap_log4j.rsp</key>
    <value>Set in Step verify hap_log4j</value>
    </Parameter>
    <Parameter>
    <key>lisa.verify hap_log4j.rsp.time</key>
    <value>Set in Step verify hap_log4j</value>
    </Parameter>
</resultState>
...
<doc>C:\trunk_331\tests\func\runtime\cl\2node_orcl.config</doc>
</Configuration>
<Configuration>
<name>CDC</name>
<external>true</external>
...
<Parameters>
    ...
    <Parameter>
    <key>fileOut</key>
    <value>{{tibco.test.case.log.dir}}/0307/hpa-log4j.xml</value>
