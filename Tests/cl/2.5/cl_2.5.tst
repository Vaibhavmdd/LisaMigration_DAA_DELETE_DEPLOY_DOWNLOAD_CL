...
<TestCase name="cl_2.5" version="5">
...
<id>f2e92539</id>
<Documentation>Description :  Define 2 loggers: root and com.tibco for Application deployed.Set Addtivity=False with ClearText File Appender for com.tibco logger,&#13;&#10;               check the log from root logger to verify.&#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="153CBD741FC311EE8BDE506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL2_5_DEBUG.log</value>
...
<SaveProps>
    ...
    <Node name="verifyrootLog" log=""
      ...
      <!-- Assertions -->
<CheckResult assertTrue="true" name="Check for error log" type="com.itko.lisa.test.CheckResultContains">
<log>Contain &apos;{{errorResp}}&apos; in info log</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{errorResp}}</param>
</CheckResult>

<CheckResult assertTrue="true" name="Check for warn log" type="com.itko.lisa.test.CheckResultContains">
<log>Contain &apos;{{warnResp}}&apos; in info log</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{warnResp}}</param>
</CheckResult>

<CheckResult assertTrue="true" name="Check for info log" type="com.itko.lisa.test.CheckResultContains">
<log>Contain &apos;{{infoResp2}}&apos; in info log</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{infoResp2}}</param>
</CheckResult>

<CheckResult assertTrue="true" name="Check for debug log" type="com.itko.lisa.test.CheckResultContains">
<log>Contain &apos;{{debugResp}}&apos; in info log</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{debugResp}}</param>
</CheckResult>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL2_5_root.log</value>
    <name>File to read</name>
    </Parameter>
    <Parameter>
    <key>encoding</key>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="F71B93681FC211EE8BDE506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
