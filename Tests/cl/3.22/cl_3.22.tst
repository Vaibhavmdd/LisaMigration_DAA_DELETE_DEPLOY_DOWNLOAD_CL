...
<!-- On: Wed Aug 11 16:14:41 IST 2021 -->


<TestCase name="cl_3.22" version="2">
<id>f2e92539</id>
<Documentation>Description :  Create A JMS Appender,&#13;&#10;               Deploy a DAA that generate log with MessageID value.&#13;&#10;               Check INFO, Warn level with JMS appender and check MSGID value&#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS0zNjIyNDYwMTk=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.VerifyMSGIDValue.rsp</key>
    <value>Set in Step VerifyMSGIDValue</value>
    </Parameter>
    <Parameter>
    <key>lisa.VerifyMSGIDValue.rsp.time</key>
    <value>Set in Step VerifyMSGIDValue</value>
    </Parameter>
</resultState>
...
<external>true</external>
<doc>C:\CLAutomation\tests\func\runtime\cl\1machine_2node_orcl.config</doc>
</Configuration>
</Configurations>
...
<SaveProps>
    ...
    <Node name="VerifyDBLog" log=""
          type="com.itko.lisa.jdbc.JDBCNode" 
          version="1" 
          think="500-1000" 
 useFilters="true" 
 quiet="false" 
          next="VerifyMSGIDValue" > 
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="VerifyMSGIDValue" log=""
          type="com.itko.lisa.jdbc.JDBCNode" 
          version="1" 
          think="500-1000" 
 useFilters="true" 
...
<maxRows>-1</maxRows>
<keepOpen>false</keepOpen>
<sql>SELECT MSGID  FROM  &quot;BASEEVENTFORMAT&quot;</sql>

      <!-- Result Elements -->
<CheckResult assertTrue="false" name="Check MsgID" type="com.itko.lisa.jdbc.CheckResultJDBCValue">
<log>Did not contain &apos;{{MSGID}}&apos; in query result</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <column>MSGID</column>
        <regEx>{{MSGID}}</regEx>
