...
<TestCase name="cl_2.15" version="5">
...
<id>9f9a4397</id>
<Documentation>Description :   Test ClearText Logging for tracing     &#13;&#10;                CL-2292:&#13;&#10;                Admin UI provides the Add Appender capability to an existing logger which CLI doesn&apos;t have. &#13;&#10;                We should be able to add appender to an existing logger through CLI.&#13;&#10;                &#13;&#10;                steps:&#13;&#10;                create and configure ClearText Appender to existing logger &quot;root&quot; for Host level, check files&#13;&#10;                to make sure this appender added successfully, delete this appender in both Host and Logging&#13;&#10;                Appender page ,check the &quot;hpa-log4j.xml&quot; to verify results.</Documentation>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="92B88A0B245D11EEA420506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="createAppender" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL2_15_Text.log</value>
...
<save>lisa.end.rsp.time</save>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="8898FCED245D11EEA420506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
