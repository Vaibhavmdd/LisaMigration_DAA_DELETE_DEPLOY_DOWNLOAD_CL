...
<!-- On: Wed Aug 11 16:15:24 IST 2021 -->


<TestCase name="cl_3.25" version="2">
<id>f2e92539</id>
<Documentation>Description :  Sometimes logservice need to be undeployed and then deployed by user, Logservice should work fine after undeploy/deploy.&#13;&#10;               By default logservice is in running status after setup case done.&#13;&#10;               Undeploy and then deploy the logservice daa&#13;&#10;               Create A JMS Appender to log message&#13;&#10;               Deploy a DAA and invoke it to generate logs&#13;&#10;               Query and check logs to make sure log servive  is working fine&#13;&#10;     &#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS0zMTQ2NDQxNzE=</sig>
<rootNode>UndeployThenDeployLogservice</rootNode>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.UndeployThenDeployLogservice.rsp</key>
    <value>Set in Step UndeployThenDeployLogservice</value>
    </Parameter>
    <Parameter>
    <key>lisa.UndeployThenDeployLogservice.rsp.time</key>
    <value>Set in Step UndeployThenDeployLogservice</value>
    </Parameter>
    <Parameter>
...
<doc>{{LISA_TC_PATH}}/../1machine_2node_orcl{{g11n}}.config</doc>
    ...
    <Node name="UndeployThenDeployLogservice" log=""
...
<Parameters>
    ...
    <Parameter>
    <key>targetName</key>
    <value>UndeployThenDeploy.logservice</value>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="VerifyPayloadKeyID" log=""
          type="com.itko.lisa.jdbc.JDBCNode" 
          version="1" 
          think="500-1000" 
 useFilters="true" 
