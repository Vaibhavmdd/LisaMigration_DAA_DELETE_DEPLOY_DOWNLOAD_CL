...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="CAAFA24027AC11EEB8EF506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="createAppender" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL3_41_Text.log</value>
...
<save>lisa.end.rsp.time</save>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="C10CE54227AC11EEB8EF506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
