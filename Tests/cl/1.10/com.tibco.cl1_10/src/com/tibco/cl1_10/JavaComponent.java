...
import com.tibco.cl1_10.JavaComponent;
import com.tibco.cl1_10.AbstractJavaComponent;
...
public class JavaComponent extends AbstractJavaComponent {
	...
	public OneToNinetyNine getNumber(OneToNinetyNine part1) {
		...
		javaLogger.info("The input 1_10QA value:" + input);
		javaLogger.debug("Debug.say 1_10QA log message in Java component");
		javaLogger.info("Info.say 1_10QA log message in Java component");
		javaLogger.warn("Warn.say 1_10QA log message in Java component");
		javaLogger.error("Error.say 1_10QA log message in Java component");
		javaLogger.trace("Trace.say 1_10QA log message in Java component");
