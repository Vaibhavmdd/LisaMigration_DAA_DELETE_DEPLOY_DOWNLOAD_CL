...
<TestCase name="cl_1.10" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/04/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/05/2023" host="na2devasgora03" />
</meta>

<id>f2e92539</id>
<Documentation>Description :  Create A  CBE Appender,&#13;&#10;               Deploy a DAA that generate log with  defined MessageID value.&#13;&#10;               Check INFO, Warn Error level with JMS appender and check MSGID value&#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS0xODM4MTY4MjU=</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="FA43CFDA1AFD11EE8675506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
...
<CheckResult assertTrue="false" name="Check for MsgID" type="com.itko.lisa.test.CheckResultContains">
<log>Error  Log not found</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{MSGID}}</param>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_10_DEBUG.log</value>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="EB624CD91AFD11EE8675506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
