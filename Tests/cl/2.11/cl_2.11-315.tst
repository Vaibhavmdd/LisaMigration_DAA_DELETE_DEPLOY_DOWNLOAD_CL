...
<!-- On: Wed Feb 19 15:46:32 CST 2014 -->


<TestCase name="2.11-315" version="2">
<id>b1d4ebcf</id>
...
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTcyNzAyOTM1Mw==</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.PatternLayoutChecking.rsp</key>
    <value>Set in Step PatternLayoutChecking</value>
    </Parameter>
    <Parameter>
    <key>lisa.PatternLayoutChecking.rsp.time</key>
    <value>Set in Step PatternLayoutChecking</value>
    </Parameter>
    <Parameter>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{TIBCO_HOST_CONFIG}}/{{host.instance}}/nodes/{{env.node2.name}}/configuration/node-log4j.xml</value>
...
<SaveProps>
<save>lisa.readFile.rsp.time</save>
</SaveProps>
