...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="A0ED94C91B1211EE8BDE506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="CreateFileAppender" > 
...
<onError>abort</onError>
    ...
    <Node name="CreateFileAppender" log=""
          ...
          version="1" 
          uid="f2e92539-CreateFileAppender" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="deployApp" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_11_TRACE.log</value>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="7404B1D51B1211EE8BDE506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
