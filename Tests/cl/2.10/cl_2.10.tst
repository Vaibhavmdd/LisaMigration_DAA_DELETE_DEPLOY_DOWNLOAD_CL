...
<TestCase name="cl_2.10" version="5">
...
<id>f2e92539</id>
<Documentation>Description :   ClearText file appender with macro name defined to handle whole nodes  CL-2179&#13;&#10;                &#13;&#10;              &#13;&#10;                Configure a ClearText appender for SytemNode &quot;com.tibco&quot; logger&#13;&#10;                This appender should be define its file path like &quot;../logs/%%_node.name%%.log&quot;&#13;&#10;                check logs from nodes, %%_node.name%%.log should be replaced with &quot;SystemNode.log&quot;</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS02ODg3OTk2Nzc=</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="BE43CEA3209311EEB76D506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="CreateAppender" > 
...
<valueToAssertKey></valueToAssertKey>
        <param>Successfully created File log appender</param>
</CheckResult>
...
<SaveProps>
    ...
    <Node name="verifyRuntimeNodeNameLogExist" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="f2e92539-verifyRuntimeNodeNameLogExist" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="end" > 
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="B0BEF572209311EEB76D506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
