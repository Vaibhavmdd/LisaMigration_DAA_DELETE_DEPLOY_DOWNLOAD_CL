...
<TestCase name="cl_3.35" version="5">
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="D55073C22A0011EEB2BC506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<SaveProps>
    ...
    <Node name="DeleteLogger" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-DeleteLogger" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="invokeService" > 
      ...
      <!-- Assertions -->
<CheckResult assertTrue="false" name="Assert145" type="com.itko.lisa.test.CheckResultContains">
<log>deleted log configuration failed</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>Successfully deleted log configuration</param>
</CheckResult>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL3_35_Text.log</value>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="D08B22ED2A0011EEB2BC506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
