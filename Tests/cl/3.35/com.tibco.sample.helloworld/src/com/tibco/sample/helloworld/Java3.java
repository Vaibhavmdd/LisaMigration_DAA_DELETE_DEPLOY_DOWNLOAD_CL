...
//				+ parentcontextId);
		...
		logger.debug("QA,debug.say3_35 hello in java3 component");
		logger.info("QA,info.say3_35 hello in java3 component");
		logger.warn("QA,warn.say3_35 hello in java3 component");
		logger.error("QA,error.say3_35 hello in java3 component");
		logger.trace("QA,trace.say3_35 hello in java3 component");
