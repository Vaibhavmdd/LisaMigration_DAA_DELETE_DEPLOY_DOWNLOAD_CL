...
<!-- On: Wed Mar 16 12:55:40 IST 2022 -->


<TestCase name="cl_3.12" version="2">
<id>f2e92539</id>
<Documentation>Description :  Create A JMS Appender ,&#13;&#10;               Check INFO, Warn, Error level with JMS appender log&#13;&#10;               Verify ExpirationTimeinDB is not null after it was configured in JMS appender&#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTIwODc1MjkyMTU=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.VerifyEXPIRATIONTIMEINDB1.rsp</key>
    <value>Set in Step VerifyEXPIRATIONTIMEINDB1</value>
    </Parameter>
    <Parameter>
    <key>lisa.VerifyEXPIRATIONTIMEINDB1.rsp.time</key>
    <value>Set in Step VerifyEXPIRATIONTIMEINDB1</value>
    </Parameter>
    <Parameter>
...
<external>true</external>
<doc>C:\CLAutomation\tests\func\runtime\bat\2node_sqlsvr.config</doc>
</Configuration>
<Configuration>
...
<SaveProps>
 ...
 useFilters="true" 
 quiet="false" 
          next="VerifyEXPIRATIONTIMEINDB1" > 
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="VerifyEXPIRATIONTIMEINDB1" log=""
          type="com.itko.lisa.jdbc.JDBCNode" 
          version="1" 
          think="500-1000" 
 useFilters="true" 
...
<maxRows>-1</maxRows>
<keepOpen>false</keepOpen>
<sql>SELECT EXPIRATIONTIMEINDB  FROM  &quot;BASEEVENTFORMAT&quot;</sql>

      <!-- Result Elements -->
<CheckResult assertTrue="false" name="Check EXPIRATIONTIMEINDB in  log" type="com.itko.lisa.jdbc.CheckResultJDBCValue">
<log>Did not contain &apos;{{EXPIRATIONTIMEINDB}}&apos; in query result</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <column>EXPIRATIONTIMEINDB</column>
        <regEx>{{EXPIRATIONTIMEINDB}}</regEx>
</CheckResult>
