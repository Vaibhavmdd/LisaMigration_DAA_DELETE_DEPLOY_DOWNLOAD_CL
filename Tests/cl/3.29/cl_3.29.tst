...
<!-- On: Wed Aug 11 16:18:46 IST 2021 -->


<TestCase name="cl_3.29" version="2">
<id>f2e92539</id>
<Documentation>Description :  Sometimes Payload service need to be stopped and then started by user, payload service should work fine after undeploy/deploy.&#13;&#10;               By default payload service is in running status after setup case done.&#13;&#10;               Undeploy and then deploy the payload daa&#13;&#10;               Create A JMS Appender to log message&#13;&#10;               Deploy a DAA and invoke it to generate logs&#13;&#10;               Query and check logs to make sure payload servive  is working fine&#13;&#10;     &#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTE1MjMxMjEyNjM=</sig>
<rootNode>StopThenStartPayloadservice</rootNode>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.StopThenStartPayloadservice.rsp</key>
    <value>Set in Step StopThenStartPayloadservice</value>
    </Parameter>
    <Parameter>
    <key>lisa.StopThenStartPayloadservice.rsp.time</key>
    <value>Set in Step StopThenStartPayloadservice</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.VerifyDAALog.rsp</key>
    <value>Set in Step VerifyDAALog</value>
    </Parameter>
    <Parameter>
    <key>lisa.VerifyDAALog.rsp.time</key>
    <value>Set in Step VerifyDAALog</value>
    </Parameter>
    <Parameter>
...
<doc>{{LISA_TC_PATH}}/../1machine_2node_orcl{{g11n}}.config</doc>
    ...
    <Node name="StopThenStartPayloadservice" log=""
...
<maxRows>-1</maxRows>
<keepOpen>false</keepOpen>
<sql>SELECT ELT FROM &quot;BASEEVENTFORMAT_PAYLOADIDS&quot; WHERE BASEEVENTFORMAT_PAYLOADIDS_ID in (SELECT E_ID  FROM  &quot;BASEEVENTFORMAT&quot; WHERE MSG like &apos;%dummy%&apos;) ORDER BY BASEEVENTFORMAT_PAYLOADIDS_ID DESC</sql>
