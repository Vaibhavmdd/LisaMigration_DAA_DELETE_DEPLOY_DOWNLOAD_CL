package com.tibco.sample.cl3_3;

import org.osoa.sca.annotations.Init;
import org.osoa.sca.annotations.Destroy;

import com.tibco.sample.cl3_3.JavaComponent;
import com.tibco.sample.cl3_3.AbstractJavaComponent;
...
public class JavaComponent extends AbstractJavaComponent {
	...
	public OneToNinetyNine getNumber(OneToNinetyNine part1) {
		...
		javaLogger.info("The input 33QA value:" + input);
		javaLogger.debug("Debug.say 33QA log message in Java component");
		javaLogger.info("Info.say 33QA log message in Java component");
		javaLogger.warn("Warn.say 33QA log message in Java component");
		javaLogger.error("Error.say 33QA log message in Java component");
		javaLogger.trace("Trace.say 33QA log message in Java component");
