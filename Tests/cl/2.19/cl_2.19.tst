...
<!-- On: Tue Feb 18 17:49:37 CST 2014 -->


<TestCase name="cl_2.19" version="5">
<id>9f9a4397</id>
<Documentation>Description :   Test &quot;Use the node&apos;s logging configuration&quot; for Application level.&#13;&#10;                Deploy one APP with logging configuration in SystemNode, invoke and check logs to make&#13;&#10;                sure this logging configuration works normally, delete this logging configuration &#13;&#10;                and this APP will use the &quot;root&quot; logger in SystemNode&apos;s logging configuration instead ,&#13;&#10;                invoke and check result in log.    &#13;&#10;      &#13;&#10;Scenario:       SOAP BT(HTTP) &lt;-&gt; Java1 &lt;-&gt; Java2&lt;-&gt; Java3</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTIwOTI1MTI5NDg=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.verifyAPPNodeLog.rsp.time</key>
    <value>Set in Step verifyAPPNodeLog</value>
    </Parameter>
    <Parameter>
    <key>lisa.Copy of invokeService.rsp.time</key>
    <value>Set in Step Copy of invokeService</value>
    </Parameter>
    <Parameter>
    <key>lisa.re-invokeService.rsp.time</key>
    <value>Set in Step re-invokeService</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.re-verifySystemNodeLog.rsp.time</key>
    <value>Set in Step re-verifySystemNodeLog</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.verifyAPPNodeLog.rsp</key>
    <value>Set in Step verifyAPPNodeLog</value>
    </Parameter>
    <Parameter>
    <key>lisa.re-invokeService.rsp</key>
    <value>Set in Step re-invokeService</value>
    </Parameter>
    <Parameter>
    <key>lisa.re-verifySystemNodeLog.rsp</key>
    <value>Set in Step re-verifySystemNodeLog</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.CheckAMXVersion.rsp</key>
    <value>Set in Step CheckAMXVersion</value>
    </Parameter>
    <Parameter>
    <key>lisa.CheckAMXVersion.rsp.time</key>
    <value>Set in Step CheckAMXVersion</value>
    </Parameter>
</resultState>
<Configurations>
...
ZWw6c2F5SGVsbG8+DQogICA8L3NvYXBlbnY6Qm9keT4NCjwvc29hcGVudjpFbnZlbG9wZT4NCg==</soapRequest>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL2_19_Text.log</value>
    <name>File to read</name>
    </Parameter>
    <Parameter>
    <key>encoding</key>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="re-verifySystemNodeLog" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
