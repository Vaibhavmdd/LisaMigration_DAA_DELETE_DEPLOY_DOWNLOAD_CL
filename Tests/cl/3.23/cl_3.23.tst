...
<!-- On: Wed Aug 11 16:14:56 IST 2021 -->


<TestCase name="cl_3.23" version="2">
<id>f2e92539</id>
<Documentation>Description :  Deploy a DAA (SOAP-Java), Send Soap Request to generate log ,&#13;&#10;               The logs whick include Soap BT will be in the Node&apos;s log on which the DAA was deployed&#13;&#10;               Verify SOAP BT Log in Node&apos;s log. see CL-1675&#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTE0OTE1MzI5ODA=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa. VerifySoapBTLog.rsp</key>
    <value>Set in Step  VerifySoapBTLog</value>
    </Parameter>
    <Parameter>
    <key>lisa. VerifySoapBTLog.rsp.time</key>
    <value>Set in Step  VerifySoapBTLog</value>
    </Parameter>
    <Parameter>
...
<name>CDC</name>
<external>true</external>
<doc>C:\CLAutomation\tests\func\runtime\cl\1machine_2node_hsql.config</doc>
</Configuration>
<Configuration>
...
<name>Config</name>
<external>true</external>
<doc>C:\CLAutomation\tests\func\runtime\cl\2node_db2.config</doc>
</Configuration>
</Configurations>
...
<CheckResult assertTrue="false" name="Check Error Level log" type="com.itko.lisa.jdbc.CheckResultJDBCValue">
<log>Did not contain &apos;{{errorResp}}&apos; in query result</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <column>MSG</column>
        <regEx>{{errorResp}}</regEx>
</CheckResult>

    </Node>


    <Node name=" VerifySoapBTLog" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
...
<SaveProps>
      ...
      <!-- Result Elements -->
<CheckResult assertTrue="true" name="Check for SoapBT log1" type="com.itko.lisa.test.CheckResultContains">
<log>Did not contain &apos;{{SoapBTlog1}}&apos; in node response</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{SoapBTlog1}}</param>
</CheckResult>

<CheckResult assertTrue="true" name="Check for SoapBT log2" type="com.itko.lisa.test.CheckResultContains">
<log>Did not contain &apos;{{SoapBTlog2}}&apos; in node response</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>{{SoapBTlog2}}</param>
</CheckResult>
