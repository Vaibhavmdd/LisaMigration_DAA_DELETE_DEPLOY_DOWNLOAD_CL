Description :  Create a Cleartext Appender,Deploy a DAA on QAnode1 without any logging configuration given.
...
Note: this is a copy of 1.14. just change CBE to cleartext appender