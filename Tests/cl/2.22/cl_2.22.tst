...
<!-- On: Thu Oct 18 12:47:40 GMT+08:00 2012 -->


<TestCase name="cl_2.22" version="2">
<id>f2e92539</id>
<Documentation>Description :  Create a ClearText Appender,Deploy a DAA on QAnode1 without any logging configuration given.&#13;&#10;               now the DAA&apos;s logs will be recorded by root&apos;s  appender of QAnode1. &#13;&#10;               Add a appender for root logger of QAnode1&#13;&#10;               Invoke (with Data set loop ) the DAA to generate logs &#13;&#10;               Check INFO, Warn, Error level log with CBE Appender log&#13;&#10;               Check the rolling Log file exsits (AMRP-3718)&#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal&#13;&#10;&#13;&#10;Note: this is just a copy of 1.14. just change CBE appender to ClearText appender&#13;&#10;&#13;&#10;&#13;&#10;</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTE1NzU3MTc0OTQ=</sig>
<rootNode>CreateFileAppender</rootNode>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.VerifyDBLog.rsp.time</key>
    <value>Set in Step VerifyDBLog</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.verifyDAARollingLogExist.rsp</key>
    <value>Set in Step verifyDAARollingLogExist</value>
    </Parameter>
    <Parameter>
    <key>lisa.verifyDAARollingLogExist.rsp.time</key>
    <value>Set in Step verifyDAARollingLogExist</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.depolyLogging.rsp</key>
    <value>Set in Step depolyLogging</value>
    </Parameter>
    <Parameter>
    <key>lisa.depolyLogging.rsp.time</key>
    <value>Set in Step depolyLogging</value>
    </Parameter>
    <Parameter>
    <key>InvokeLoop_RowNum</key>
    <value>Set in Step invokeService</value>
    </Parameter>
    <Parameter>
    <key>InvokeTimes</key>
...
<doc>D:\CLAutomation\tests\func\runtime\bat\2node_db2.config</doc>
</Configuration>
<Configuration>
<name>CDC</name>
<external>true</external>
...
<doc>{{LISA_TC_PATH}}/../1machine_2node_orcl{{g11n}}.config</doc>
    ...
    <Node name="CreateFileAppender" log=""
...
<Parameters>
    ...
    <Parameter>
    <key>logFileName</key>
    <value>{{tibco.test.case.log.dir}}/DeployLogging.log</value>
    <name>Absolute path to the Ant log file. Optional.</name>
    </Parameter>
    <Parameter>
    <key>targetName</key>
...
<SaveProps>
    ...
    <Node name="verifyLogs" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          think="0-0" 
 useFilters="true" 
 quiet="false" 
          next="verifyRollingLogExist" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_14_DEBUG.log</value>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_14_DEBUG.log.1</value>
...
<graphy>10</graphy>
    ...
    <DataSet type="com.itko.lisa.test.DataFile" name="InvokeLoop" atend="wait" local="true" >
<sample>rO0ABXNyABFqYXZhLnV0aWwuSGFzaE1hcAUH2sHDFmDRAwACRgAKbG9hZEZhY3RvckkACXRocmVz
aG9sZHhwP0AAAAAAAAx3CAAAABAAAAADdAAAcQB+AAJ0ABFJbnZva2VMb29wX1Jvd051bXQAATF0
AAtJbnZva2VUaW1lc3QAATF4</sample>
    <location>{{LISA_TC_PATH}}/InvokeLoop.csv</location>
    <delim>,</delim>
    <bundle>false</bundle>
    </DataSet>
