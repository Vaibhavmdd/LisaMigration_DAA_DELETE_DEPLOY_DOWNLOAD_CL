package com.tibco.sample.cl3_6;
...
import com.tibco.sample.cl3_6.JavaComponent;
import com.tibco.sample.cl3_6.AbstractJavaComponent;
...
public class JavaComponent extends AbstractJavaComponent {
	...
	public OneToNinetyNine getNumber(OneToNinetyNine part1) {
		...
		javaLogger.info("The input 3_6QA value:" + input);
		javaLogger.debug("Debug.say 3_6QA log message in Java component");
		javaLogger.info("Info.say 3_6QA log message in Java component");
		javaLogger.warn("Warn.say 3_6QA log message in Java component");
		javaLogger.error("Error.say 3_6QA log message in Java component");
		javaLogger.trace("Trace.say 3_6QA log message in Java component");
