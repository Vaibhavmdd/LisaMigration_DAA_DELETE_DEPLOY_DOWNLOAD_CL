...
<TestCase name="cl_3.36" version="5">
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="7DD5FD7529FB11EEB2BC506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<valueToAssertKey></valueToAssertKey>
        <param>Application &apos;cl3_36&apos; Deploy with Start finished successfully</param>
</CheckResult>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL3_36_Text.log</value>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="7B0EEDA329FB11EEB2BC506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
