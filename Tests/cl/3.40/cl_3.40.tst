...
<TestCase name="cl_3.40" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/19/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/21/2023" host="na2devasgora03" />
</meta>

<id>9f9a4397</id>
<Documentation>Description :   Test ClearText Logging for tracing     &#13;&#10;                CL-2292:&#13;&#10;                Admin UI provides the Add Appender capability to an existing logger which CLI doesn&apos;t have. &#13;&#10;                We should be able to add appender to an existing logger through CLI.&#13;&#10;                &#13;&#10;                steps:&#13;&#10;                create and configure ClearText Appender &quot;qaFileLogAppender3_40&quot; to existing logger &quot;root&quot;&#13;&#10;                for Host level, check files &quot;hpa-log4j.xml&quot; and &quot;CL3_40_Text.log&quot; to verify results</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS00NjA5NTcxNjA=</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="30AB3627262B11EEB8EF506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="createAppender" > 
...
<SaveProps>
    ...
    <Node name="AddAppender" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-AddAppender" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="applyLogging" > 
...
<Parameters>
    ...
    <Parameter>
    <key>logFileName</key>
    <value>{{tibco.test.case.log.dir}}/addAppender.log</value>
    <name>Absolute path to the Ant log file. Optional.</name>
    </Parameter>
    <Parameter>
    <key>targetName</key>
...
<SaveProps>
    ...
    <Node name="applyLogging" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-applyLogging" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="verifyAppender" > 
...
<Parameters>
    ...
    <Parameter>
    <key>logFileName</key>
    <value>{{tibco.test.case.log.dir}}/applyLogging.log</value>
    <name>Absolute path to the Ant log file. Optional.</name>
    </Parameter>
    <Parameter>
    <key>targetName</key>
    <value>apply.logging</value>
    <name>Name of the build target to be invoked. Optional.</name>
    </Parameter>
    <Parameter>
    <key>propertyFileName</key>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{TIBCO_CONFIG_HOME}}\tibcohost\Admin-AMXAdmin-admin1\data_3.2.x\host\configuration\hpa-log4j.xml</value>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL3_40_Text.log</value>
...
<save>lisa.end.rsp.time</save>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="2D398E72262B11EEB8EF506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
