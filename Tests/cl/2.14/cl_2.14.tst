...
<TestCase name="cl_2.14" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/13/2023" host="na2devasgora03" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176" author="admin" date="07/14/2023" host="na2devasgora03" />
</meta>

<id>9f9a4397</id>
<Documentation>Description :   Test ClearText Logging for tracing     &#13;&#10;                CL-2292:&#13;&#10;                Admin UI provides the Add Appender capability to an existing logger which CLI doesn&apos;t have. &#13;&#10;                We should be able to add appender to an existing logger through CLI.&#13;&#10;                &#13;&#10;                steps:&#13;&#10;                create and configure ClearText Appender to existing logger &quot;com.tibco&quot; for SystemNode level, &#13;&#10;                check files to make sure this appender added successfully, delete this appender in both &#13;&#10;                SystemNode and Logging Appender page ,check the &quot;node-log4j.xml&quot; to verify results.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS02MDQ2NzcyMzY=</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="A0498CF216911EEAF26506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="createAppender" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL2_14_Text.log</value>
...
<SaveProps>
    ...
    <Node name="re-depolyLogging" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="9f9a4397-re-depolyLogging" 
          think="0" 
          useFilters="true" 
          quiet="false" 
...
<save>lisa.end.rsp.time</save>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="F649C855216811EEAF26506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
