...
<TestCase name="cl_1.4" version="5">
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="1AFA00D0141311EE8675506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_4_DEBUG.log</value>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_4_root.log</value>
    <name>File to read</name>
    </Parameter>
    <Parameter>
    <key>encoding</key>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="164E2C6E141311EE8675506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
