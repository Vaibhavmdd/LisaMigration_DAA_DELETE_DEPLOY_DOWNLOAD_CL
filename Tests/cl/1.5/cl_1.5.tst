...
<TestCase name="cl_1.5" version="5">
...
<id>f2e92539</id>
<Documentation>Description :  Define 2 loggers: root and com.tibco for Application deployed.Set Addtivity=False with CBE File Appender for com.tibco logger,&#13;&#10;               check the log from root logger to verify.&#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="48F078CF172211EE8675506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_5_DEBUG.log</value>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_5_root.log</value>
    <name>File to read</name>
    </Parameter>
    <Parameter>
    <key>encoding</key>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="B4C40D52141511EE8675506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
