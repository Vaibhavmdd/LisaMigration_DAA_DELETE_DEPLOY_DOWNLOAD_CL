...
<!-- On: Tue Jun 26 23:52:38 CDT 2012 -->


<TestCase name="cl_3.18" version="2">
<id>f2e92539</id>
<Documentation>Description :   Update JMS Appender without payload&#13;&#10;                &#13;&#10;Scenario:       SOAP HTTP &lt;-&gt; Mediation1 &lt;-&gt; Mediation2&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTE5Mjc3ODAzOTc=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.updateLogging.rsp.time</key>
    <value>Set in Step updateLogging</value>
    </Parameter>
    <Parameter>
    <key>lisa.updateLogging.rsp</key>
    <value>Set in Step updateLogging</value>
    </Parameter>
    <Parameter>
...
<doc>C:\CLAutomation\tests\func\runtime\bat\2node_hsql.config</doc>
</Configuration>
<Configuration>
<name>CDC</name>
<external>true</external>
...
<Parameters>
    ...
    <Parameter>
    <key>logFileName</key>
    <value>{{tibco.test.case.log.dir}}/updateLogging.log</value>
    <name>Absolute path to the Ant log file. Optional.</name>
    </Parameter>
    <Parameter>
    <key>targetName</key>
    <value>update.logging</value>
    <name>Name of the build target to be invoked. Optional.</name>
    </Parameter>
    <Parameter>
    <key>propertyFileName</key>
    ...
    <Parameter>
    <key>propertyList</key>
    <value>TIBCO_HOME={{TIBCO_HOME}},TIBCO_AMXADMIN_HOME={{TIBCO_AMXADMIN_HOME}},TIBCO_AMX_LIBRARY={{TIBCO_AMX_LIBRARY}},amxConfigFile={{tibco.amx.datafile.tc}},appenderConfigFile={{LISA_TC_PATH}}/appenderdata.xml,remotePropsFile={{tibco.test.suite.config.path}},timeout={{timeout}}</value>
    <name>Name value pairs seperated by comma. ex: name1=value1,name2=value2,.. etc. This can be used in addition to passing property file. Optional</name>
    </Parameter>
    <Parameter>
    <key>antOpts</key>
...
<CheckResult assertTrue="false" name="Check for Response2" type="com.itko.lisa.test.CheckResultContains">
<log>Common Logging update Log Appender failed</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>Update Log Appender</param>
</CheckResult>
...
eT4NCiAgICAgIDxtYXQ6U3VidHJhY3Q+DQogICAgICAgICA8bWF0OmE+e3thfX08L21hdDphPg0K
ICAgICAgICAgPG1hdDpiPnt7Yn19PC9tYXQ6Yj4NCiAgICAgIDwvbWF0OlN1YnRyYWN0Pg0KICAg
...
<sql>SELECT DTYPE,MSG FROM  &quot;BASEEVENTFORMAT&quot;</sql>
