...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="7F2B50ED173311EE8675506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<SaveProps>
    ...
    <Node name="confLogging2" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="f2e92539-confLogging2" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="invokeService" > 
...
<url>http://{{tibco.amx.rt.httpconnector1.host}}:{{tibco.amx.rt.httpconnector1.port}}/helloWorldPT/</url>
...
<SaveProps>
    ...
    <Node name="verifyNodeLog" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="f2e92539-verifyNodeLog" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="undeployApp" > 
...
<log>Did not contain &apos;{{nodeResp2}}&apos; in Node log</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{tibco.test.case.log.dir}}/CL1_8_DEBUG.log</value>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="5BC5BA86173311EE8675506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
