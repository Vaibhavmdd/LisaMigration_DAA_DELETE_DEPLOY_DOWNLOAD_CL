...
import com.tibco.cl3_21.JavaComponent;
import com.tibco.cl3_21.AbstractJavaComponent;
...
public class JavaComponent extends AbstractJavaComponent {
	...
	public OneToNinetyNine getNumber(OneToNinetyNine part1) {
		...
		javaLogger.info("The input 3_21QA value:" + input);
		javaLogger.debug("Debug.say 3_21QA log message in Java component");
		javaLogger.info("Info.say 3_21QA log message in Java component");
		javaLogger.warn("Warn.say 3_21QA log message in Java component");
		javaLogger.error("Error.say 3_21QA log message in Java component");
		javaLogger.trace("Trace.say 3_21QA log message in Java component");
		...
		logMap.put(HashMapping.CL_MSG_ID, "BWENGINE-999999");
