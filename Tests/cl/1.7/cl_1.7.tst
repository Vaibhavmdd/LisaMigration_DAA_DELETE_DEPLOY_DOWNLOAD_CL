...
<TestCase name="cl_1.7" version="5">
...
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPTc3MjQ2NjIw</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="AD8B593172F11EE8675506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
...
<SaveProps>
    ...
    <Node name="copy SystemNode_log4j" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="f2e92539-copy+SystemNode_log4j" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
...
<Parameters>
    <Parameter>
    <key>fileIn</key>
    <value>{{TIBCO_CONFIG_HOME}}/tibcohost/{{host.instance}}/data_3.2.x/nodes/SystemNode/configuration/node-log4j.xml</value>
...
<save>lisa.createDirectory.rsp.time</save>
    ...
    <Node name="verify SystemNode_log4j" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="f2e92539-verify+SystemNode_log4j" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="end" > 
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="5977DFE172F11EE8675506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
