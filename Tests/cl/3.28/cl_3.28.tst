...
<!-- On: Wed Aug 11 16:18:23 IST 2021 -->


<TestCase name="cl_3.28" version="2">
<id>f2e92539</id>
<Documentation>Description :  Sometimes Payload service need to be undeployed and then deployed by user, payload service should work fine after undeploy/deploy.&#13;&#10;               By default payload service is in running status after setup case done.&#13;&#10;               Undeploy and then deploy the payload daa&#13;&#10;               Create A JMS Appender to log message&#13;&#10;               Deploy a DAA and invoke it to generate logs&#13;&#10;               Query and check logs to make sure payload servive  is working fine&#13;&#10;     &#13;&#10;&#13;&#10;Scenario:      SOAP HTTP &lt;-&gt; Java&#13;&#10;&#13;&#10;MEP: In-Out &#13;&#10;SOAP Version: 1.1 &#13;&#10;SOAP Style/Encoding: Document/Literal</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPTExNDY2NjA1NjA=</sig>
<rootNode>UndeployThenDeployPayloadservice</rootNode>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.UndeployThenDeployPayloadservice.rsp</key>
    <value>Set in Step UndeployThenDeployPayloadservice</value>
    </Parameter>
    <Parameter>
    <key>lisa.UndeployThenDeployPayloadservice.rsp.time</key>
    <value>Set in Step UndeployThenDeployPayloadservice</value>
    </Parameter>
    <Parameter>
...
<doc>{{LISA_TC_PATH}}/../1machine_2node_orcl{{g11n}}.config</doc>
    ...
    <Node name="UndeployThenDeployPayloadservice" log=""
...
<Parameters>
    ...
    <Parameter>
    <key>targetName</key>
    <value>UndeployThenDeploy.Payloadservice</value>
