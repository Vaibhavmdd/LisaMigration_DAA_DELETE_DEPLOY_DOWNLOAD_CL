...
<TestCase name="CreateTopic" version="5">
...
<id>bc11aed5</id>
<Documentation>Creates a Topic on EMS Server.&#13;&#10;Note that it tried to delete the Topic first before creating it.&#13;&#10;Make sure the TIBCO EMS Admin jar is in the LISA classpath.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9MiZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYuaGYzMykmbm9kZXM9LTMzNDc1Mzk0OA==</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.createTopic.rsp</key>
    <value></value>
    <name>lisa.createTopic.rsp</name>
    </Parameter>
    <Parameter>
    <key>lisa.createTopic.rsp.time</key>
    <value></value>
    <name>lisa.createTopic.rsp.time</name>
    </Parameter>
    <Parameter>
...
<log>Creating Topic &quot;{{topicName}}&quot; bound to JNDI name &quot;{{jndiName}}&quot;&#13;&#10;on {{url}}</log>
    </Node>


    <Node name="createTopic" log=""
          type="com.itko.lisa.test.ScriptNode" 
          version="1" 
          uid="bc11aed5-createTopic" 
          think="0-0" 
          useFilters="true" 
          quiet="false" 
          next="end" > 
...
<log>EMS Topic creation has thrown Exception</log>
<then>fail</then>
...
<script>import com.tibco.tibjms.admin.*;&#13;&#10;&#13;&#10;String errorMsg = &quot;EMS Error&quot;; // Do not modify, assertions on this string might exist.&#13;&#10;String successMsg = &quot;EMS Topic creation success&quot;;&#13;&#10;String msg = &quot;&quot;;&#13;&#10;String topicName = testExec.parseInState(topicName);&#13;&#10;String jndiName = testExec.parseInState(jndiName);&#13;&#10;&#13;&#10;try {&#13;&#10;    TopicInfo destInfo = new TopicInfo(topicName);&#13;&#10;    EMSAdmin.destroyTopic(topicName);&#13;&#10;    EMSAdmin.createTopic(destInfo);&#13;&#10;&#13;&#10;    if (!jndiName.equals(&quot;&quot;) &amp;&amp; !jndiName.equals(&quot;&lt;&lt;null&gt;&gt;&quot;))&#13;&#10;        EMSAdmin.bindTopic(jndiName, topicName);&#13;&#10;&#13;&#10;    msg = successMsg;&#13;&#10;}&#13;&#10;catch (Exception e) {&#13;&#10;    msg = errorMsg + &quot;: &quot; + e.getClass().getName() + &quot; &quot; + e.getMessage();&#13;&#10;}&#13;&#10;finally {&#13;&#10;    EMSAdmin.close();&#13;&#10;    return msg;&#13;&#10;}</script>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="BF1906078CE911EDAFE8506B8D8BDEB5" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
