...
<TestCase name="DeleteQueue" version="5">
...
<id>bc11aed5</id>
<Documentation>Deletes a Queue on EMS Server.&#13;&#10;Make sure the TIBCO EMS Admin jar is in the LISA classpath.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9MiZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYuaGYzMykmbm9kZXM9LTk2NTYwNDM2MQ==</sig>
...
<resultState>
    ...
    <value></value>
    <name>lisa.deleteQueue.rsp</name>
    </Parameter>
    <Parameter>
    <key>lisa.deleteQueue.rsp.time</key>
    <value></value>
    <name>lisa.deleteQueue.rsp.time</name>
    </Parameter>
    <Parameter>
...
<log>Deleting Queue &quot;{{queueName}}&quot; ...</log>
    </Node>
...
<script>import com.tibco.tibjms.admin.*;&#13;&#10;&#13;&#10;String errorMsg = &quot;EMS Error&quot;; // Do not modify, assertions on this string might exist.&#13;&#10;String successMsg = &quot;EMS Queue deletion success&quot;;&#13;&#10;String msg = &quot;&quot;;&#13;&#10;String queueName = testExec.parseInState(queueName);&#13;&#10;&#13;&#10;try {&#13;&#10;    EMSAdmin.destroyQueue(queueName);&#13;&#10;    msg = successMsg;&#13;&#10;}&#13;&#10;catch (Exception e) {&#13;&#10;    msg = errorMsg + &quot;: &quot; + e.getClass().getName() + &quot;. &quot; + e.getMessage();&#13;&#10;}&#13;&#10;finally {&#13;&#10;    EMSAdmin.close();&#13;&#10;    return msg;&#13;&#10;}&#13;&#10;</script>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="AEAE99658CE911EDAFE8506B8D8BDEB5" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
