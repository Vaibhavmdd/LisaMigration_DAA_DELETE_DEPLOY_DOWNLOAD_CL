...
<TestCase name="PurgeQueue" version="5">

<meta>
   <create version="10.7.2" buildNumber="10.7.2.176.hf33" author="admin" date="01/04/2023" host="na2devasgaks01" />
   <lastEdited version="10.7.2" buildNumber="10.7.2.176.hf33" author="admin" date="01/04/2023" host="na2devasgaks01" />
</meta>

<id>bc11aed5</id>
<Documentation>Purges a Queue on EMS Server.&#13;&#10;Make sure the TIBCO EMS Admin jar is in the LISA classpath.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9MiZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYuaGYzMykmbm9kZXM9LTM3ODkxMjUyMQ==</sig>
...
<resultState>
    ...
    <value></value>
    <name>lisa.purgeQueue.rsp</name>
    </Parameter>
    <Parameter>
    <key>lisa.purgeQueue.rsp.time</key>
    <value></value>
    <name>lisa.purgeQueue.rsp.time</name>
    </Parameter>
</resultState>
...
<log>Purging Queue &quot;{{queueName}}&quot; ...</log>
    </Node>
...
<log>EMS Queue purge has thrown Exception</log>
<then>fail</then>
...
<script>import com.tibco.tibjms.admin.*;&#13;&#10;&#13;&#10;String errorMsg = &quot;EMS Error&quot;; // Do not modify, assertions on this string might exist.&#13;&#10;String successMsg = &quot;EMS Queue purge success&quot;;&#13;&#10;String msg = &quot;&quot;;&#13;&#10;String queueName = testExec.parseInState(queueName);&#13;&#10;&#13;&#10;try {&#13;&#10;    EMSAdmin.purgeQueue(queueName);&#13;&#10;    msg = successMsg;&#13;&#10;}&#13;&#10;catch (Exception e) {&#13;&#10;    msg = errorMsg + &quot;: &quot; + e.getClass().getName() + &quot;. &quot; + e.getMessage();&#13;&#10;}&#13;&#10;finally {&#13;&#10;    EMSAdmin.close();&#13;&#10;    return msg;&#13;&#10;}</script>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="3C2320F28CCE11ED9DD2506B8D8BDEB5" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
