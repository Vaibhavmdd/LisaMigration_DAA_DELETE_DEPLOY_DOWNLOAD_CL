...
<!-- On: Tue Sep 11 17:06:53 PDT 2012 -->


<TestCase name="UpgradeNode" version="2">
<id>10e34bf4</id>
<Documentation>Upgrades Node from 3.1.2 to higher version.&#13;&#10;</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS0xODk1MTM1MDg0</sig>
...
<initState>
    ...
    <Parameter>
    <key>antLogFile</key>
    <value>{{tibco.test.case.log.dir}}/upgradeNode-{{nodeName}}.log</value>
    </Parameter>
    <Parameter>
    <key>propFile</key>
    <value></value>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.UpgradeNode.rsp.time</key>
    <value>Set in Step UpgradeNode</value>
    </Parameter>
    <Parameter>
    <key>lisa.UpgradeNode.rsp</key>
    <value>Set in Step UpgradeNode</value>
    </Parameter>
    <Parameter>
...
<graphx>10</graphx>
<graphy>10</graphy>
      <log>Upgrading Node {{nodeName}} on host {{hostName}} from upgrade script location - {{upgradeScriptsPath}}</log>
    </Node>
...
<Parameters>
    <Parameter>
    <key>file</key>
    <value>{{propertyFileLocation}}/upgrade-{{nodeName}}.properties</value>
...
<Parameters>
    ...
    <Parameter>
    <key>antOpts</key>
    <value>-Xms128m -Xmx1024m -XX:MaxPermSize=256m -XX:-UseGCOverheadLimit -XX:-UseConcMarkSweepGC -Djava.classes.dir=/{{=TIBCO_JAVA_HOME.replace(&quot;\\&quot;,&quot;/&quot;)}}/jre/lib -Dapp.name.com.tibco.amx.it.mediation.apt=com.tibco.amx.it.mediation.app</value>
...
<log>Upgrade for node : {{nodeName}} did not start on time</log>
<then>timeout</then>
<valueToAssertKey></valueToAssertKey>
...
<log>{{antLogFile}} file not found yet...</log>
...
<log>{{nodeName}} has successfully upgraded</log>
<then>success</then>
<valueToAssertKey></valueToAssertKey>
...
<log>{{nodeName}} upgrade failed</log>
<then>failure</then>
<valueToAssertKey></valueToAssertKey>
...
<log>{{nodeName}} upgrade did not start on time</log>
<then>timeout</then>
<valueToAssertKey></valueToAssertKey>
        <script>future.before(Calendar.getInstance());</script>
</CheckResult>
...
<graphy>674</graphy>
<onerror>fail</onerror>
<script>return &quot;Node upgrade did not start on time.\n\n\n&quot; + antLogContent;</script>
