...
<!-- On: Fri Oct 09 10:27:57 PDT 2009 -->


<TestCase name="StopJ2EE" version="2">
<id>b38e0c85</id>
<Documentation>This subprocess stops the J2EE server by taking the host and the server type.&#13;&#10;It stops the server at the specified j2eeHome. &#13;&#10;If the host is a remote system, the value for j2eeHome should be set to the location which is available on the host specified. &#13;&#10;If j2eeHome is not specified:&#13;&#10;&#9;If type is tibcohost, then the value of variable TIBCO_HOST_HOME on the appropriate host will be used.&#13;&#10;The default type is tibcohost.&#13;&#10;The default host is localhost.</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNCAoNC42LjQuNykmbm9kZXM9LTMxMjYyODQwMA==</sig>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="stopTibcoHost" log="stop  the tibcohost on the specified host"
...
<Parameters>
    ...
    <name>TibcoHost home directory</name>
    </Parameter>
    <Parameter>
    <key>timeout</key>
    <value>{{timeout}}</value>
