...
<!-- On: Tue Mar 23 17:30:08 PDT 2010 -->


<TestCase name="StartAllJ2EE" version="2">
<id>b38e0c85</id>
<Documentation>This subprocess starts the server by taking the environment and the server type.&#13;&#10;It then starts all the servers of this type in the given environment.&#13;&#10;The list of tibcohosts systems are retrieved from the data file used.&#13;&#10;On each system, If the Servertype is tibcohost, the tibcohost located under TIBCO_HOST_HOME will be started through LISA simulator.</Documentation>
<sig>ZWQ9MiZ0Y3Y9MiZsaXNhdj00LjYuNyAoNC42LjcuMTYpJm5vZGVzPS0zMzE0MDU1NjY=</sig>
...
<resultState>
    ...
    <Parameter>
    <key>lisa.startAllTibcoHosts.rsp.time</key>
    <value>Set in Step startAllTibcoHosts</value>
    </Parameter>
    <Parameter>
    ...
    <Parameter>
    <key>lisa.startAllTibcoHosts.rsp</key>
    <value>Set in Step startAllTibcoHosts</value>
    </Parameter>
    <Parameter>
...
<valueToAssertKey></valueToAssertKey>
    ...
    <Node name="startAllTibcoHosts" log="start all the tibcohosts specified in the amx environment"
...
<graphx>488</graphx>
<graphy>0</graphy>
<Subprocess>{{TIBCO_AMX_LIBRARY}}/com/tibco/tibcohost/StartAllTibcoHosts.tst</Subprocess>
