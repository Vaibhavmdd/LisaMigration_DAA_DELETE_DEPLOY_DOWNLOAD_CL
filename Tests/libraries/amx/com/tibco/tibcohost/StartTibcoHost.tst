...
<TestCase name="StartTibcoHost" version="5">
...
<SaveProps>
    ...
    <Node name="repeatingCheckLogFileExists" log="check if log file got created"
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="aa488cd-repeatingCheckLogFileExists" 
          think="0" 
          useFilters="true" 
          quiet="false" 
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="8842E9499E1D11ED8E7C506B8D8BDEB5" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
