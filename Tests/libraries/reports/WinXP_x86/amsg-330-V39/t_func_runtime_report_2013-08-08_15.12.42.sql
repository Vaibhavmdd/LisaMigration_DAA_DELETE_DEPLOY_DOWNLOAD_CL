insert into tsi_tests_run(run_id, hostname, platform, user_name, start_time, end_time, product_name, product_version, product_build, category, status, num_tc_started, num_tc_passed, num_tc_failed, num_tc_manual, num_tc_uncertain, log_url, note, t_tests_version, num_tc_error) values('hparmar-t410-2013/08/08-15:12:42', 'hparmar-t410', 'WinXP_x86', 'superuser', to_date('2013/08/08-15:12:42', 'yyyy/mm/dd-hh24:mi:ss'), null, 'amsg', '330', 'Version 3.3.0 build V39', 'runtime', null, 0, 0, 0, 0, 0, 'WinXP_x86/amsg-330-V39', null, 'LISA4.6', 0)
insert into tsi_tests_set(run_id, seq_no, set_name, owner, start_time, end_time, num_tc_started, num_tc_passed, num_tc_failed, num_tc_manual, num_tc_uncertain, log_url, note, num_tc_error) values('hparmar-t410-2013/08/08-15:12:42', null, 'unknown', 'superuser', to_date('2013/08/08-15:12:42', 'yyyy/mm/dd-hh24:mi:ss'), null, 0, 0, 0, 0, 0, 'func/runtime/bat/unknown', null, 0)
insert into tsi_tests_case(run_id, set_name, case_id, variant_seq, test_result, is_manual, note) values('hparmar-t410-2013/08/08-15:12:42', 'unknown', '5.6', '1', 'PASSED', 'N', null)
...
MEP: In-Out')
update tsi_tests_set set seq_no=1, end_time=to_date('2013/08/08-15:15:08', 'yyyy/mm/dd-hh24:mi:ss'), num_tc_passed=1, num_tc_failed=0, num_tc_error=0 where run_id='hparmar-t410-2013/08/08-15:12:42' and set_name='unknown'
update tsi_tests_run set end_time=to_date('2013/08/08-15:15:08', 'yyyy/mm/dd-hh24:mi:ss'), status='COMPLETED', num_tc_passed=1, num_tc_failed=0, num_tc_error=0 where run_id='hparmar-t410-2013/08/08-15:12:42'
