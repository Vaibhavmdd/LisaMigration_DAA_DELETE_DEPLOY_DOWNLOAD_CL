...
<TestCase name="deployments_1.11" version="5">
...
<id>e361c023</id>
<Documentation>Scenario&#13;&#10;========&#13;&#10;Description: Test the Wiring between the promoted reference of Composite 2 and service of Composite 1 using Virtualization.&#13;&#10;&#13;&#10;Composite 1: SOAP(Virtualization and SOAP/HTTP Binding) &lt;-&gt; JAVA (The SOAP servcie has HTTP endpoint) --&gt; Upload in environment 1 --&gt; Promote SVB binding to environment level --&gt; Deploy in environment1&#13;&#10;Composite 2: SOAP(Virtualization and SOAP/HTTP Binding) &lt;-&gt; JAVA &lt;-&gt; Reference (SOAP/HTTP Binding)--&gt; Upload in environment 2 --&gt; Promote the reference to environment level --&gt; Wire&#13;&#10;                                                      &#13;&#10;Wire: Reference (SOAP/HTTP Binding) [Composite 2] To SOAP (Virtualization) [Composite 1] &#13;&#10;Deploy Composite2.&#13;&#10;&#13;&#10;Result: Wiring will fail with &quot;Service virtualization cannot be used across environments&quot; error.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS0zNjQ4ODc4NjE=</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="569AE694FF9711EDA27D506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="setupEnvironment" > 
...
<onError>abort</onError>
    ...
    <Node name="setupEnvironment" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="e361c023-setupEnvironment" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="deployApp1" > 
...
<SaveProps>
    ...
    <Node name="deployApp2" log=""
      ...
      <!-- Assertions -->
<CheckResult assertTrue="false" name="Assert145" type="com.itko.lisa.test.CheckResultContains">
<log>Build was expected to fail but could not find &apos;BUILD FAILED&apos;</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
...
<log>Service virtualization was expected to fail but couls not find &apos;Service virtualization cannot be used across environments&apos;</log>
<then>fail</then>
<valueToAssertKey></valueToAssertKey>
        <param>Service virtualization cannot be used across environments</param>
</CheckResult>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="50EC6F3CFF9711EDA27D506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
