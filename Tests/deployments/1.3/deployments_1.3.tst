...
<TestCase name="deployments_1.3" version="5">
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="B0CAD02FFEC411EDA27D506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp" > 
...
<url>http://{{host1}}:8891/Wiring1_3/</url>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="937C1159FEC411EDA27D506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
