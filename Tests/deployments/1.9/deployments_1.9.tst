...
<TestCase name="deployments_1.9" version="5">
...
<id>185dcd1</id>
<Documentation>Scenario&#13;&#10;========&#13;&#10;Description: Test the Wiring of reference of Composite 2 to the SOAP service of Composite 1 using Virtualization. And change the wiring of Composite 2 reference to point to SOAP service end point of Composite1.&#13;&#10;&#13;&#10;Composite 1: SOAP(Virtualization and SOAP/HTTP Binding) &lt;-&gt; JAVA (The SOAP servcie has HTTP endpoint) --&gt; Deploy &#13;&#10;Composite 2: SOAP(Virtualization and SOAP/HTTP Binding) &lt;-&gt; JAVA &lt;-&gt; Reference (The reference is configured with concrete wsdl) --&gt; Deploy&#13;&#10;                                                      &#13;&#10;Wire 1: Reference (With concrete wsdl) [Composite 2] To SOAP (Virtualization) [Composite 1]&#13;&#10;Wire 2: Reference (with concrete wsdl) [Composite 2] To SOAP (SOAP/HTTP binding) [Composite 1] &lt;-&gt; &#13;&#10;Redeploy Composite 2.&#13;&#10;&#13;&#10;Result: Wiring will be done.</Documentation>
<IsInProject>true</IsInProject>
<sig>ZWQ9NSZ0Y3Y9NSZsaXNhdj0xMC43LjIgKDEwLjcuMi4xNzYpJm5vZGVzPS04NTk4MDE0NDk=</sig>
...
<deletedProps>
    ...
    <Node name="Properties Reader from data.txt" log=""
          ...
          version="1" 
          uid="58B3AB7FFF8B11EDA27D506B8DD34562" 
          think="500-1S" 
          useFilters="true" 
          quiet="true" 
          next="deployApp1" > 
...
<url>http://{{host1}}:8891/Wiring1_9/</url>
...
<SaveProps>
    ...
    <Node name="RedeployApp2" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="185dcd1-RedeployApp2" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="ReInvokeAMXService" > 
...
<SaveProps>
    ...
    <Node name="ReInvokeAMXService" log=""
          type="com.itko.lisa.ws.RawSOAPNode" 
          version="1" 
          uid="185dcd1-ReInvokeAMXService" 
          think="500-1000" 
          useFilters="true" 
          quiet="false" 
          next="undeployApp22" > 
...
<customHTTPHeaderInfo>
    ...
    <Node name="undeployApp22" log=""
          type="com.itko.lisa.utils.ExecSubProcessNode" 
          version="1" 
          uid="185dcd1-undeployApp22" 
          think="0" 
          useFilters="true" 
          quiet="false" 
          next="end" > 
...
<Parameters>
    ...
    <Parameter>
    <key>targetName</key>
    <value>undeploy.myrenewapp</value>
    <name>Name of the build target to be invoked. Optional.</name>
    </Parameter>
    <Parameter>
    <key>propertyFileName</key>
...
<SaveProps>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="30AF86B4FF8B11EDA27D506B8DD34562" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="end" > 
